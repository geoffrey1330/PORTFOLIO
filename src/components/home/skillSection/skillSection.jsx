...
class SkillSection extends Component {
  ...
  render() {
    ...
    return (
      <section
        className={
          darkMode ? "skill-section skill-section-dark" : "skill-section"
        }
      >
        ...
        <div className="more-container">
          ...
          <div ref={this.moreRef} className="more">
            <div
              className={
                darkMode ? "my-col shadow col my-col-dark" : "my-col shadow col"
              }
            >
              <h4>Front-end</h4>
              <ul>
            ...
            >
              ...
              <ul>
                ...
                <li>
                  <b>Machine Learning with Tensorflow and SKLearn</b>
                </li>
                <li>
                  <b>OpenCV</b>
                </li>
